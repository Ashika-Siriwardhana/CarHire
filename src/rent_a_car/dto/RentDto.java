...
public class RentDto {
    ...
    public RentDto(Integer rentId, Integer carId, String custId, String fromDate, String toDate, Double dayPrice, Double total, Double refundDeposit, String isReturnRefundDeposit, Double advanceAmount, Double balanceAmount, Double additionalCharge, String isReturnCar) {
        this.rentId = rentId;
        this.carId = carId;
        this.custId = custId;
