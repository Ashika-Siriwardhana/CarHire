...
public class CustomerEntity {
    ...
    public CustomerEntity(String custID, String custName, String custNIC, String custAddress, String custTPNo) {
        this.custID = custID;
    ...
    public String toString() {
        return "CustomerEntity{" + "custID=" + custID + ", custName=" + custName + ", custNIC=" + custNIC + ", custAddress=" + custAddress + ", custTPNo=" + custTPNo + '}';
    }
}
